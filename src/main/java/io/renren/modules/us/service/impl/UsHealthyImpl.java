...
import io.renren.modules.us.dao.UsHealthyDao;
...
@Service("usHealthyService")
public class UsHealthyImpl extends ServiceImpl<UsHealthyDao, UsHealthyEntity> implements UsHealthyService {
    @Value("${us.icon.path}")
    private String path;

    public PageUtils queryPage(Map<String, Object> params) {
        //查询已发布，按照时间倒序排列（部分字段）
        EntityWrapper<UsHealthyEntity> wrapper = new EntityWrapper<>();
        wrapper.setSqlSelect("id","title","icon","create_date","summary").eq("status",1)
